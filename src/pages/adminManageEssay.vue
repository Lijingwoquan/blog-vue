<template>
    ...
    >
      ...
      <ul>
        <li class="dateList">
          ...
          <el-input
            ...
            class="updateInput"
          ></el-input>
          <el-button style="width: 80%" type="primary" size="large" disabled
            >选择文章</el-button
          >
          <el-button style="width: 80%" type="primary" size="large" disabled
            >删除文章</el-button
      ...
      <ul v-if="getData">
        <li v-for="essay in satisfyDate" class="dateList">
          ...
          ></el-input>
          <el-input
            v-model="essay.introduction"
            disabled
            placeholder="文章介绍"
            class="updateInput"
          ></el-input>
          <el-input
            v-model="essay.router"
            disabled
            placeholder="文章路由"
            class="updateInput"
          ></el-input>
  ...
  >
    ...
    文章名
    <el-input
      v-model="updateEssayMsgObj.name"
      placeholder="文章名"
      class="dialogInput"
    />
    ...
    路由
    <el-input
      v-model="updateEssayMsgObj.router"
      placeholder="路由"
      class="dialogInput"
    />
    ...
    介绍
    <el-input
      v-model="updateEssayMsgObj.introduction"
      placeholder="介绍"
      class="dialogInput"
    />
