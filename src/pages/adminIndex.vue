  ...
  <div class="flex flex-col justify-center items-center px-15 mt-10">
    ...
    <div class="flex mt-10" style="width: 100%;">
      <el-card shadow="never" style="width: 100%;height: 300px;">
        ...
        <el-row :gutter="20">
          <el-col :span="8" v-for="(item, index) in userVisitedCountArr" :key="index">
            <el-card shadow="never" class="border-0 bg-light-400 flex justify-center items-center">
